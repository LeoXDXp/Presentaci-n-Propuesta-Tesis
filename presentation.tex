...
\note[itemize]{
    \item En consecuencia con lo mencionado hasta el momento con respecto al estado del arte y las dificultades de individualizar filamentos en imágenes de microscopía, se establece la hipótesis que señala que es posible identificar filamentos mediante un modelo de optimización si se cuenta con un grafo con ciertas características como dato de entrada.
