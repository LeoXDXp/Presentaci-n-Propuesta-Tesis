...
\note[itemize]{
    ...
    \item y finalmente, Evaluar t\'ecnicas que usan s\'olo herramientas de procesamiento de im\'agenes de bajo nivel, basada en poblaci\'on de p\'ixeles, o herramientas que utilizan un m\'etodo derivado de contornos activos.
}
